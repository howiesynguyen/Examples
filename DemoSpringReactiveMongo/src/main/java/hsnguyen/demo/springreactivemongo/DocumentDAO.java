...
public interface DocumentDAO extends ReactiveCrudRepository<MyDocument, String> {
    Flux<MyDocument> findAllByOwner(String owner);
    //Mono<MyDocument> findById(Mono<String> id);
