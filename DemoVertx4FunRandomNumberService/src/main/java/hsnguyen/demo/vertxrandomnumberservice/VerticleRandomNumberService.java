 ...
 *******************************************************************************/
package hsnguyen.demo.vertxrandomnumberservice;
...
public class VerticleRandomNumberService extends AbstractVerticle {
	private static Logger logger = LoggerFactory.getLogger(VerticleRandomNumberService.class);
    ...
    public void start(Promise<Void> promise) throws Exception {
        ...
        vertx.eventBus().<JsonObject>consumer("api.randomnumber", replymsg -> {
        	...
        	replymsg.headers().set("content-type", "application/json");
        	
        	replymsg.replyAndRequest(jsonobj);
        });       
    ...
    //For further testing, refer to hsnguyen.demo.vertxrandomnumberservice.test.VerticleRandomNumberServiceTest
    public static void main(String[] args) {
		logger.info("Deploying VerticleRandomNumberService...");
	    Vertx.clusteredVertx(new VertxOptions())
	      .compose(vertx -> vertx.deployVerticle(new VerticleRandomNumberService()))
