...
@Import({ExampleSource.class, ExampleProcessors.class, ExampleSink.class})
public class DemoSpringCloudStreamHelloWorldApplication {

	public static void main(String[] args) {
		SpringApplication.run(DemoSpringCloudStreamHelloWorldApplication.class, args);
	}
